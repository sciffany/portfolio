                ...
                {navbarItems.map((item, index) => {
                  ...
                  return (
                    <Link
                      key={item.href}
                      href={item.href}
                      className={`block text-center rounded-lg text-lg py-3 transition-all duration-300 transform hover:scale-105 ${
                        active
            ...
            <div className="p-6 border-t border-gray-500">
              <div className="flex items-center justify-center space-x-4">
                <a
                  ...
                  className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-900 hover:bg-gray-800 transition-colors"
                  aria-label="Email"
                >
                  <svg
